...
- (void)setTextValue:(CGFloat)value
{
    ...
    else
    {
        ...
        if([self.format rangeOfString:@"%(.*)d" options:NSRegularExpressionSearch].location != NSNotFound || [self.format rangeOfString:@"%(.*)i" options:NSRegularExpressionSearch].location != NSNotFound )
        {
