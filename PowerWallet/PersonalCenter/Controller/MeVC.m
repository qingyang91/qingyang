...
@interface MeVC ()<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
-(void)createAvatarView{
    _headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_WIDTH/2.5+10)];
    _headerView.backgroundColor = Color_GRAY;
    
    UIImageView *bgImg = [[UIImageView alloc] init];
    bgImg.image = [UIImage imageNamed:@"head_banner"];
...
-(void)showData{
    ...
    NSArray *array = @[
                       @[@{@"strIcon":@"more_icon_info",@"strTitle":@"信用",@"strContent":@""},
                         @{@"strIcon":@"more_icon_info",@"strTitle":@"信用",@"strContent":@""}],
//                       @[@{@"strIcon":@"more_icon_info",@"strTitle":@"信用",@"strContent":@""}],
