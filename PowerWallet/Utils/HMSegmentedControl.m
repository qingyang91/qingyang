...
- (void)drawRect:(CGRect)rect {
    ...
    for ( int i = 0; i < self.sectionTitles.count; i++ ){
        UIView *LineView = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/self.sectionTitles.count + i *SCREEN_WIDTH/self.sectionTitles.count, 7, 1, self.frame.size.height-14)];
