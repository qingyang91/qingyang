...
@interface LoginSecViewController ()<UITextFieldDelegate>
...
- (void)createUI{
    ...
    _pwdTf.leftView = [self leftView:@"login_pwd_icon" superView:_pwdTf];
    ...
    [_forgetPwdBtn setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];
