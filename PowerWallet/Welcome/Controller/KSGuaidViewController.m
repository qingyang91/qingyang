...
//    [self.view addSubview:self.pageControl];
    ...
    if (iPhone4) {
        self.hiddenBtn.frame = CGRectMake(40 + SCREEN_WIDTH * self.imageNames.count, SCREEN_HEIGHT - 80, SCREEN_WIDTH -80, 40);
    }else{
        self.hiddenBtn.frame = CGRectMake(40 + SCREEN_WIDTH * self.imageNames.count, SCREEN_HEIGHT-(SCREEN_HEIGHT/3*2), SCREEN_WIDTH-80, SCREEN_HEIGHT/3-100);
    }
...
- (void)viewDidLayoutSubviews{
    ...
    self.hiddenBtn.center = CGPointMake(CGRectGetWidth(self.view.frame) * point.x,
                                        CGRectGetHeight(self.view.frame) * (point.y-0.04));
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (current == self.imageNames.count -2) {
