...
- (void)initCellStyleWithLabel:(UILabel *)label Status:(BOOL)isSelected {
    ...
    self.titleLabel.textColor = isSelected ?  self.themeColor ? self.themeColor : [UIColor orangeColor] : [UIColor lightGrayColor];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if (scrollView.tag == CONTENT) {
        ...
        if (index < self.currentIndex) {
            ...
            [self changeLabelColor:currentLabel To:[UIColor orangeColor] WithScale:(1 - (indexValue - index))];
            [self changeLabelColor:nextLabel To:self.themeColor ? self.themeColor : [UIColor orangeColor] WithScale:(1 - (indexValue - index))];
            ...
            [self changeLabelColor:currentLabel To:[UIColor orangeColor] WithScale:(indexValue - index)];
            [self changeLabelColor:nextLabel To:self.themeColor ? self.themeColor : [UIColor orangeColor] WithScale:(indexValue - index)];
        }
    }
}
...
//    self.titleLabel.text = label.text;
//    self.titleLabel.font = label.font;
//    self.titleLabel.textColor = isSelected ?  self.themeColor ? self.themeColor : SXColor(12, 158, 255, 1.0) : [UIColor whiteColor];
//    [self addSubview:self.titleLabel];
//    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.edges.mas_equalTo(0);
//    }];
...
//    self = [super initWithFrame:frame];
//    if (self) {
//        self.backgroundColor = SXColor(32, 40, 51, 1.0);
//    }
//    return self;
//}
//
